...
public class BlocksCreator implements BlockCreator {
     ...
     *
     * @param xpos - value of the upper left point of the block.
     * @param ypos - value of the upper left point of the block.
     * @return - an object of a block.
     */
    public Block create(int xpos, int ypos) {
        return new Block(new Point(xpos, ypos), this.width, this.height, this.stroke, this.hitPoints, this.colors,
                images);
    }
