...
import backgrounds.BackgroundColor;
...
/**
 * The class reads level specifications from file and creates
 * a level information object to create a level for the game.
 *
 * @author David Regev.
 * @version 8.6.2018.
 */
public class LevelSpecificationReader {
    ...
    /**
     * The function translates the file to a list
                        ...
                        switch (splitedLine[0]) {
                            ...
                            case "ball_velocities":
                                ...
                                for (String str : velocities) {
                                    ...
                                    int angle = Integer.parseInt(velocity[0]) - 90;
